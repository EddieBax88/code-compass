/**
 * Code Compass — Search Mode (Ctrtoode Lookup)
        ...
        <div className="p-6 lg:p-8 space-y-6">
          ...
          <div className="space-y-3">
            {results.map(q => (
              <div
                key={q.id}
                className="panel-card p-5 rounded-sm hover:border-primary/30 transition-all"
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="mt-3 flex items-start gap-2 text-xs">
                      <span className="font-mono text-muted-foreground uppercase tracking-wide flex-shrink-0">
                        Index:
                      </span>
