//#region node_modules/.nitro/vite/services/ssr/assets/curriculum-BoKKyowv.js
var TRADES = [
  {
    id: "electrical",
    name: "Electrical",
    blurb: "NEC, PLCs, industrial controls",
    icon: "⚡",
  },
];
var PASS = 80;
var EDITION_TOKEN = "__EDITION__";
var COURSES = [
  {
...
var courseById = (id) => COURSES.find((c) => c.id === id);
var coursesByTrade = (t) => COURSES.filter((c) => c.trade === t);
/**
 ...
 */
function applyEdition(value, edition) {
  const ed = edition ?? "—";
  const walk = (v) => {
...
//#endregion
export { coursesByTrade as a, courseById as i, TRADES as n, applyEdition as r, COURSES as t };
