...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Blycjpwu.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B5XYItUW.mjs"),
		import("./start-BvyWHp90.mjs"),
		import("./empty-plugin-adapters-CaFDqkDN.mjs")
	]);
	return {
		routerEntry,
		startEntry,
