...
(0, import_main.config)({ path: resolve(dirname(fileURLToPath(import.meta.url)), "..", "..", ".env") });
var serverEntryPromise;
async function getServerEntry() {
	if (!serverEntryPromise) serverEntryPromise = import("./server-BRgVcVkt.mjs").then((m) => m.default ?? m);
