//#region node_modules/.pnpm/@supabase+postgrest-js@2.110.2/node_modules/@supabase/postgrest-js/dist/index.mjs
/**
...
var PostgrestBuilder = class {
  ...
  constructor(builder) {
    ...
    this.shouldStripNulls =
      (_builder$shouldStripN = builder.shouldStripNulls) !== null &&
      _builder$shouldStripN !== void 0
        ? _builder$shouldStripN
        : false;
    this.urlLengthLimit =
      (_builder$urlLengthLim = builder.urlLengthLimit) !== null && _builder$urlLengthLim !== void 0
        ...
        : 8e3;
    this.retryEnabled =
      (_builder$retry = builder.retry) !== null && _builder$retry !== void 0
        ? _builder$retry
        : true;
      ...
      while (true) {
        ...
        try {
          res$1 = await _fetch(_this.url.toString(), {
            method: _this.method,
            headers,
            body: JSON.stringify(_this.body, (_, value) =>
    ...
    if (res.ok) {
      ...
      if (_this2.method !== "HEAD") {
        ...
        if (body === "") {
          ...
          _this2.headers.get("Accept") &&
          ((_this$headers$get = _this2.headers.get("Accept")) === null ||
      ...
      const countHeader =
        (_this$headers$get2 = _this2.headers.get("Prefer")) === null ||
        _this$headers$get2 === void 0
          ? void 0
          : _this$headers$get2.match(/count=(exact|planned|estimated)/);
      const contentRange =
        (_res$headers$get2 = res.headers.get("content-range")) === null ||
        _res$headers$get2 === void 0
          ? void 0
...
var PostgrestClient = class PostgrestClient {
  ...
  constructor(
    url,
    { headers = {}, schema, fetch: fetch$1, timeout, urlLengthLimit = 8e3, retry } = {},
  ) {
    this.url = url;
    this.headers = new Headers(headers);
