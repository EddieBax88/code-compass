...
//#endregion
//#region node_modules/.pnpm/@supabase+storage-js@2.110.2/node_modules/@supabase/storage-js/dist/index.mjs
function _typeof(o) {
...
var _getRequestParams = (method, options, parameters, body) => {
  ...
  if (isPlainObject(body)) {
    ...
    params.headers = setHeader(
      headers,
      "Content-Type",
      (_contentType = contentType) !== null && _contentType !== void 0
        ? _contentType
        : "application/json",
    );
...
var StorageFileApi = class extends BaseApiClient {
  ...
  async createSignedUrl(path, expiresIn, options) {
    ...
    return _this8.handleOperation(async () => {
      ...
      let data = await post(
        ...
        _objectSpread2({ expiresIn }, hasTransform ? { transform: options.transform } : {}),
      ...
      return {
        signedUrl: encodeURI(
          `${_this8.url}${data.signedURL}${queryString ? `&${queryString}` : ""}`,
        ),
      };
    });
  }
        ...
        _objectSpread2(
          ...
          {},
          {
            signedUrl: datum.signedURL
              ? encodeURI(`${_this9.url}${datum.signedURL}${queryString ? `&${queryString}` : ""}`)
              : null,
          },
        ),
      );
  ...
  async purgeCache(path, options, parameters) {
    ...
    return _this13.handleOperation(async () => {
      ...
      return await remove(
        _this13.fetch,
        `${_this13.url}/cdn/${_path}${queryString ? `?${queryString}` : ""}`,
        {},
  ...
  async list(path, options, parameters) {
    ...
    return _this14.handleOperation(async () => {
      const sortBy = (options === null || options === void 0 ? void 0 : options.sortBy)
        ? _objectSpread2(_objectSpread2({}, DEFAULT_SEARCH_OPTIONS.sortBy), options.sortBy)
      ...
      return await post(
        _this14.fetch,
        `${_this14.url}/object/list/${_this14.bucketId}`,
        body,
  ...
  async listV2(options, parameters) {
    ...
    return _this15.handleOperation(async () => {
      ...
      return await post(
        _this15.fetch,
        `${_this15.url}/object/list-v2/${_this15.bucketId}`,
        body,
...
var StorageBucketApi = class extends BaseApiClient {
  ...
  async purgeBucketCache(id, options, parameters) {
    ...
    return _this7.handleOperation(async () => {
      ...
      return await remove(
        _this7.fetch,
        `${_this7.url}/cdn/${id}${queryString ? `?${queryString}` : ""}`,
        {},
        { headers: _this7.headers },
        parameters,
      );
