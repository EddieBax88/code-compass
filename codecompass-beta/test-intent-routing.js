...
testQueries.forEach((test, index) => {
  ...
  if (intent === 'out_of_scope') {
    console.log(`Response: "This question is outside Ugly's Reference scope. Switch to Guided Method, Index Search, or Quick Answer for NEC article lookup."`);
  } else if (intent === 'plc_l5x') {
    console.log(`Response: "For L5X parsing, please use the PLC Parser module. Upload your L5X file at /plc to parse routines, count rungs, and analyze ladder logic."`);
  } else {
